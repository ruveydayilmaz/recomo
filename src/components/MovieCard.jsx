  ...
  return (
    <div className="relative cursor-pointer" onClick={handleCardClick}>
      <div className="sm:max-w-xl sm:mx-auto">
        <div className={`rounded sm:rounded-xl p-4 flex space-x-8 ${selected ? "bg-primary-500 text-black" : "bg-white dark:bg-dark-200 dark:text-white"}`}>
          <div className="h-32 overflow-visible">
            <img className="rounded-md shadow-lg h-32 w-22" src={posterUrl} alt={movie.title} />
          </div>
          <div className="flex-1 flex-col">
            <div className="flex flex-col">
              ...
              <p><span className="font-semibold">Release Date:</span> {movie.release_date == "" ? "-" : movie.release_date.slice(0, 4)}</p>
              <p>
              ...
              <p>
                ...
                <span onClick={handleToggleOverview} className={`cursor-pointer font-semibold ${selected ? "text-white" : "text-primary-300"}`}>
                  {" "}more
                </span>
              </p>
                ...
                open && (
                  <div className={`absolute ${selected ? "bg-primary-500" : "bg-white dark:bg-dark-200 dark:text-white"} -top-2 -left-2 z-[1000] rounded-md shadow-lg min-w-[440px]`}>
                    <div className="relative">
                      <img className="w-full h-24 object-cover rounded-t-md brightness-75" src={bannerUrl} alt={movie.title} />
